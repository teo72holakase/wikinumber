...
const TRANSLATIONS = {
  "es": {
    ...
    why_p1: "Este espacio está reservado para que cuentes, en tus propias palabras, la historia detrás de WikiNumber: qué te inspiró, qué problema curioso querías resolver o qué experimento te llevó a construir esta página. Edita este texto en translations.js."
  },
  ...
  "es-ES": {
    ...
    how_p3: "Sirve como una forma curiosa de exploración: un generador de descubrimiento aleatorio pero reproducible, ideal para juegos, retos, casualidades numéricas (tu cumpleaños, tu edad, tu DNI) o simple curiosidad.",
    why_title: "¿Por qué se creó WikiNumber?",
    why_p1: "Este espacio está reservado para que cuentes, con tus propias palabras, la historia detrás de WikiNumber: qué te inspiró, qué problema curioso querías resolver o qué experimento te llevó a construir esta página. Edita este texto en translations.js."
  },
  ...
  "en": {
    ...
    why_p1: "This space is reserved for you to tell, in your own words, the story behind WikiNumber: what inspired you, what curious problem you wanted to solve, or what experiment led you to build this page. Edit this text in translations.js."
  },
  ...
  "pt": {
    ...
    why_p1: "Este espaço está reservado para você contar, com suas próprias palavras, a história por trás do WikiNumber: o que te inspirou, qual problema curioso você queria resolver ou qual experimento te levou a construir esta página. Edite este texto em translations.js."
  }
};
